...
url = "https://www.fotmob.com/api/leagues?id=223&ccode3=NOR&season=2023"
# url = "https://www.fotmob.com/api/leagues?id=64&ccode3=SWE&season=2020%2F2021"
...
for game_id in finished_games:
    ...
    try:
        ...
        print(finished_games.index(game_id), "/" ,len(finished_games), "Was not found!")
